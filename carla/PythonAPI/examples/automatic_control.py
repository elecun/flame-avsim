...
class World(object):
    ...
    def __init__(self, carla_world, hud, args):
        ...
        self._actor_filter ='vehicle.tesla.model3' # added
        self.restart(args)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYUP:
                ...
                # added
                    ...
                    spawn_point = self.world.player.get_transform()
                    print(spawn_point)
                elif event.key == K_r: # start run
                    self.start_run = True
                elif event.key == K_s: # stop run
...
class HUD(object):
    ...
    def __init__(self, width, height):
        ...
        self._show_info = False # modified
        self._info_text = []
        ...
        # added for message api
        self.message_api = {
            "flame/avsim/carla/process/mapi_launch" : self.__mapi_start_run,
            "flame/avsim/carla/process/mapi_terminate" : self.__mapi_terminate
        }

    # added for mapi
    def __mapi_start_run(self, payload):
        event = pygame.event.Event(pygame.KEYUP, key=pygame.K_r)
        pygame.event.post(event)
    # added for mapi
    def __mapi_stop_run(self, payload):
        event = pygame.event.Event(pygame.KEYUP, key=pygame.K_s)
        pygame.event.post(event)
    # added for mapi
    def __mapi_terminate(self, payload):
    ...
    def notification(self, text, seconds=2.0):
        """Notification text"""
        #self._notifications.set_text(text, seconds=seconds) # modified
        pass
...
def game_loop(args):
    ...
    try:
        ...
        world.camera_manager.toggle_camera() # added
        _lights = carla.VehicleLightState.HighBeam # added
        world.player.set_light_state(_lights) # added
        ...
        while True:
            ...
            if controller.start_run:
                print("start to run automatic control")
                break
            else:
